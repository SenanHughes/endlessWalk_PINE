...
struct Z_CompiledInDeferFile_FID_Users_senan_OneDrive_Documents_Masters_in_Computing_in_Computer_Animation_finalProject_endlessWalk_PINE_endlessWalk_Source_endlessWalk_ATileManager_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATileManager, ATileManager::StaticClass, TEXT("ATileManager"), &Z_Registration_Info_UClass_ATileManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATileManager), 1340563235U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_senan_OneDrive_Documents_Masters_in_Computing_in_Computer_Animation_finalProject_endlessWalk_PINE_endlessWalk_Source_endlessWalk_ATileManager_h_2692739445(TEXT("/Script/endlessWalk"),
